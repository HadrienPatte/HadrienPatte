...
- [cilium/statedb](https://github.com/cilium/statedb) ([v0.8.1](https://github.com/cilium/statedb/releases/tag/v0.8.1), 4 days ago) - In-memory state database for Go
...
- [ip: Add `netip.Addr`/`Prefix` wrappers for Kubernetes API types](https://github.com/cilium/cilium/pull/46047) on [cilium/cilium](https://github.com/cilium/cilium) (6 days ago)
