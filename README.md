...
- [cilium/statedb](https://github.com/cilium/statedb) ([v0.5.4](https://github.com/cilium/statedb/releases/tag/v0.5.4), 6 days ago) - In-memory state database for Go
...
- [canonical/chisel](https://github.com/canonical/chisel) ([v1.3.0](https://github.com/canonical/chisel/releases/tag/v1.3.0), 4 weeks ago) - 
...
- [vendor: Update `go-licenses` to v2](https://github.com/cilium/cilium/pull/42829) on [cilium/cilium](https://github.com/cilium/cilium) (2 days ago)
