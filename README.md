...
- [kubernetes/autoscaler](https://github.com/kubernetes/autoscaler) ([cluster-autoscaler-chart-9.55.1](https://github.com/kubernetes/autoscaler/releases/tag/cluster-autoscaler-chart-9.55.1), 2 days ago) - Autoscaling components for Kubernetes
...
- [datapath: Migrate `LocalNodeConfiguration` to `netip`](https://github.com/cilium/cilium/pull/44391) on [cilium/cilium](https://github.com/cilium/cilium) (4 days ago)
- [options: Migrate `VtepCidrMask` from `net.IP` to `netip.Addr`](https://github.com/cilium/cilium/pull/44379) on [cilium/cilium](https://github.com/cilium/cilium) (5 days ago)
