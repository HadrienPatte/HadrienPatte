...
- [DataDog/datadog-agent](https://github.com/DataDog/datadog-agent) ([7.59.0](https://github.com/DataDog/datadog-agent/releases/tag/7.59.0), 4 days ago) - Main repository for Datadog Agent
- [Sonarr/Sonarr](https://github.com/Sonarr/Sonarr) ([v4.0.10.2624](https://github.com/Sonarr/Sonarr/releases/tag/v4.0.10.2624), 1 week ago) - Smart PVR for newsgroup and bittorrent users.
...
- [padok-team/burrito](https://github.com/padok-team/burrito) ([v0.5.0](https://github.com/padok-team/burrito/releases/tag/v0.5.0), 3 weeks ago) - 🌯 Burrito is a TACoS Kubernetes Operator - &#34;ArgoCD for Terraform&#34;
- [terraform-linters/tflint-ruleset-aws](https://github.com/terraform-linters/tflint-ruleset-aws) ([v0.34.0](https://github.com/terraform-linters/tflint-ruleset-aws/releases/tag/v0.34.0), 4 weeks ago) - TFLint ruleset for terraform-provider-aws
- [DataDog/nginx-datadog](https://github.com/DataDog/nginx-datadog) ([installer-0.1.2](https://github.com/DataDog/nginx-datadog/releases/tag/installer-0.1.2), 4 weeks ago) - Enhance NGINX Observability and Security with Datadog&#39;s Module
...
- [Update changed-files action to v45](https://github.com/canonical/chisel-releases/pull/383) on [canonical/chisel-releases](https://github.com/canonical/chisel-releases) (4 days ago)
