...
- [kubernetes-sigs/controller-tools](https://github.com/kubernetes-sigs/controller-tools) ([envtest-v1.36.2](https://github.com/kubernetes-sigs/controller-tools/releases/tag/envtest-v1.36.2), 1 day ago) - Tools to use with the controller-runtime libraries
...
- [images/runtime: Update iptables-wrapper to upstream v3 (Go)](https://github.com/cilium/cilium/pull/46694) on [cilium/cilium](https://github.com/cilium/cilium) (4 days ago)
- [endpoint: Guard ENI routing rule teardown by IP ownership](https://github.com/cilium/cilium/pull/46677) on [cilium/cilium](https://github.com/cilium/cilium) (5 days ago)
- [ipam: Reclaim still-advertised released CIDRs on renewed demand](https://github.com/cilium/cilium/pull/46674) on [cilium/cilium](https://github.com/cilium/cilium) (5 days ago)
