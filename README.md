...
- [Sonarr/Sonarr](https://github.com/Sonarr/Sonarr) ([v4.0.11.2784](https://github.com/Sonarr/Sonarr/releases/tag/v4.0.11.2784), today) - Smart PVR for newsgroup and bittorrent users.
- [cilium/cilium](https://github.com/cilium/cilium) ([v1.17.0-rc.0](https://github.com/cilium/cilium/releases/tag/v1.17.0-rc.0), 3 days ago) - eBPF-based Networking, Security, and Observability
- [Lidarr/Lidarr](https://github.com/Lidarr/Lidarr) ([v2.8.2.4493](https://github.com/Lidarr/Lidarr/releases/tag/v2.8.2.4493), 5 days ago) - Looks and smells like Sonarr but made for music.
...
- [feat(24.10): Add SDF for `libtheora0` and `libx11-xcb1`](https://github.com/canonical/chisel-releases/pull/432) on [canonical/chisel-releases](https://github.com/canonical/chisel-releases) (6 days ago)
