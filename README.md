...
- [advplyr/audiobookshelf](https://github.com/advplyr/audiobookshelf) ([v2.26.2](https://github.com/advplyr/audiobookshelf/releases/tag/v2.26.2), 1 day ago) - Self-hosted audiobook and podcast server
- [hashicorp/terraform-provider-azurerm](https://github.com/hashicorp/terraform-provider-azurerm) ([v4.37.0](https://github.com/hashicorp/terraform-provider-azurerm/releases/tag/v4.37.0), 5 days ago) - Terraform provider for Azure Resource Manager
...
- [aws/eni: Don&#39;t use subnet tags to filter ENIs for GC](https://github.com/cilium/cilium/pull/40656) on [cilium/cilium](https://github.com/cilium/cilium) (today)
