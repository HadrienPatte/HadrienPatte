...
- [kubernetes/autoscaler](https://github.com/kubernetes/autoscaler) ([cluster-autoscaler-chart-9.53.0](https://github.com/kubernetes/autoscaler/releases/tag/cluster-autoscaler-chart-9.53.0), 5 days ago) - Autoscaling components for Kubernetes
...
- [deepcopy-gen: Add support for copyable value types from `net/netip`](https://github.com/kubernetes/kubernetes/pull/135572) on [kubernetes/kubernetes](https://github.com/kubernetes/kubernetes) (6 days ago)
