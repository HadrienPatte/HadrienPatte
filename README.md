...
- [cilium/statedb](https://github.com/cilium/statedb) ([v0.5.6](https://github.com/cilium/statedb/releases/tag/v0.5.6), 2 days ago) - In-memory state database for Go
...
- [ENI: Only track managed subnets in route tables](https://github.com/cilium/cilium/pull/43023) on [cilium/cilium](https://github.com/cilium/cilium) (today)
