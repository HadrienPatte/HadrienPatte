...
- [cilium/statedb](https://github.com/cilium/statedb) ([v0.6.3](https://github.com/cilium/statedb/releases/tag/v0.6.3), 2 days ago) - In-memory state database for Go
- [kubernetes/autoscaler](https://github.com/kubernetes/autoscaler) ([cluster-autoscaler-1.35.0](https://github.com/kubernetes/autoscaler/releases/tag/cluster-autoscaler-1.35.0), 5 days ago) - Autoscaling components for Kubernetes
