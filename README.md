...
- [advplyr/audiobookshelf](https://github.com/advplyr/audiobookshelf) ([v2.26.1](https://github.com/advplyr/audiobookshelf/releases/tag/v2.26.1), 3 days ago) - Self-hosted audiobook and podcast server
...
- [bpftool: make the `bpftool` binary static](https://github.com/cilium/image-tools/pull/366) on [cilium/image-tools](https://github.com/cilium/image-tools) (2 days ago)
- [build: Enforce docker build checks](https://github.com/cilium/cilium/pull/40528) on [cilium/cilium](https://github.com/cilium/cilium) (4 days ago)
