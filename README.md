...
- [cilium/hive](https://github.com/cilium/hive) ([v1.0.2](https://github.com/cilium/hive/releases/tag/v1.0.2), today) - Hive dependency injection
- [cilium/statedb](https://github.com/cilium/statedb) ([v0.8.1](https://github.com/cilium/statedb/releases/tag/v0.8.1), 5 days ago) - In-memory state database for Go
...
- [azure: Skip listing NIC of empty VMSSs](https://github.com/cilium/cilium/pull/46129) on [cilium/cilium](https://github.com/cilium/cilium) (4 days ago)
- [ipam: Remove unused ForeachAddress abstraction](https://github.com/cilium/cilium/pull/46111) on [cilium/cilium](https://github.com/cilium/cilium) (4 days ago)
- [build: Remove boringcrypto-based FIPS support](https://github.com/cilium/cilium/pull/46092) on [cilium/cilium](https://github.com/cilium/cilium) (6 days ago)
