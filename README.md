...
- [Sonarr/Sonarr](https://github.com/Sonarr/Sonarr) ([v4.0.10.2579](https://github.com/Sonarr/Sonarr/releases/tag/v4.0.10.2579), 2 days ago) - Smart PVR for newsgroup and bittorrent users.
- [jellyfin/jellyfin](https://github.com/jellyfin/jellyfin) ([v10.10.0](https://github.com/jellyfin/jellyfin/releases/tag/v10.10.0), 2 days ago) - The Free Software Media System
- [Lidarr/Lidarr](https://github.com/Lidarr/Lidarr) ([v2.7.1.4417](https://github.com/Lidarr/Lidarr/releases/tag/v2.7.1.4417), 2 days ago) - Looks and smells like Sonarr but made for music.
...
- [DataDog/datadog-agent](https://github.com/DataDog/datadog-agent) ([7.58.1](https://github.com/DataDog/datadog-agent/releases/tag/7.58.1), 4 days ago) - Main repository for Datadog Agent
...
- [zigpy/bellows](https://github.com/zigpy/bellows) ([0.41.0](https://github.com/zigpy/bellows/releases/tag/0.41.0), 1 week ago) - A Python 3 project to implement EZSP for EmberZNet devices
...
- [Auto update issue template version on new release](https://github.com/jellyfin/jellyfin/pull/12893) on [jellyfin/jellyfin](https://github.com/jellyfin/jellyfin) (1 day ago)
- [Update issue template version from 10.9.11 to 10.10.0](https://github.com/jellyfin/jellyfin/pull/12882) on [jellyfin/jellyfin](https://github.com/jellyfin/jellyfin) (2 days ago)
