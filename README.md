...
- [zigpy/bellows](https://github.com/zigpy/bellows) ([0.45.3](https://github.com/zigpy/bellows/releases/tag/0.45.3), today) - A Python 3 project to implement EZSP for EmberZNet devices
...
- [cilium/statedb](https://github.com/cilium/statedb) ([v0.4.5](https://github.com/cilium/statedb/releases/tag/v0.4.5), 1 day ago) - In-memory state database for Go
- [kubernetes/autoscaler](https://github.com/kubernetes/autoscaler) ([cluster-autoscaler-1.30.5](https://github.com/kubernetes/autoscaler/releases/tag/cluster-autoscaler-1.30.5), 4 days ago) - Autoscaling components for Kubernetes
...
- [vendor: Update Azure SDK `armcompute` module to v7](https://github.com/cilium/cilium/pull/40718) on [cilium/cilium](https://github.com/cilium/cilium) (5 days ago)
- [cilium-cli: Optimized feature detection by running cluster-wide checks once](https://github.com/cilium/cilium/pull/40715) on [cilium/cilium](https://github.com/cilium/cilium) (5 days ago)
- [cilium-cli: Use slim k8s packages for connectivity tests](https://github.com/cilium/cilium/pull/40708) on [cilium/cilium](https://github.com/cilium/cilium) (5 days ago)
- [Update README and enable `s390x` builds](https://github.com/cilium/image-tools/pull/367) on [cilium/image-tools](https://github.com/cilium/image-tools) (6 days ago)
