...
- [kubernetes/autoscaler](https://github.com/kubernetes/autoscaler) ([vertical-pod-autoscaler-1.6.0](https://github.com/kubernetes/autoscaler/releases/tag/vertical-pod-autoscaler-1.6.0), today) - Autoscaling components for Kubernetes
...
- [cilium/statedb](https://github.com/cilium/statedb) ([v0.6.3](https://github.com/cilium/statedb/releases/tag/v0.6.3), 3 days ago) - In-memory state database for Go
