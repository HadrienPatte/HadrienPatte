...
- [kubernetes/autoscaler](https://github.com/kubernetes/autoscaler) ([vertical-pod-autoscaler-chart-0.8.1](https://github.com/kubernetes/autoscaler/releases/tag/vertical-pod-autoscaler-chart-0.8.1), 1 day ago) - Autoscaling components for Kubernetes
...
- [cilium/statedb](https://github.com/cilium/statedb) ([v0.5.7](https://github.com/cilium/statedb/releases/tag/v0.5.7), 6 days ago) - In-memory state database for Go
...
- [renovate: Fix `k8s` patch updates on stable branches](https://github.com/cilium/cilium/pull/44498) on [cilium/cilium](https://github.com/cilium/cilium) (6 days ago)
- [iptables: skip intra-CILIUM_ rule removal in removeCiliumRules](https://github.com/cilium/cilium/pull/44497) on [cilium/cilium](https://github.com/cilium/cilium) (6 days ago)
