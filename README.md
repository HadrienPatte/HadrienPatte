...
- [node: Migrate `IPv{4,6}IngressIP` to netip](https://github.com/cilium/cilium/pull/47165) on [cilium/cilium](https://github.com/cilium/cilium) (today)
- [policy: Reject bare IP addresses in CIDR policy fields](https://github.com/cilium/cilium/pull/47150) on [cilium/cilium](https://github.com/cilium/cilium) (1 day ago)
- [doublewrite: Don't run CRD backend with real handler when reading from KVStore](https://github.com/cilium/cilium/pull/47144) on [cilium/cilium](https://github.com/cilium/cilium) (1 day ago)
- [Fix panic in CT map CG on agent shutdown](https://github.com/cilium/cilium/pull/47139) on [cilium/cilium](https://github.com/cilium/cilium) (1 day ago)
- [operator: Fix nil-pointer panic in CiliumNode GC](https://github.com/cilium/cilium/pull/47127) on [cilium/cilium](https://github.com/cilium/cilium) (1 day ago)
- [images/builder: Base on Ubuntu directly instead of the runtime image](https://github.com/cilium/cilium/pull/47096) on [cilium/cilium](https://github.com/cilium/cilium) (4 days ago)
- [Migrate `Node.IPv{4,6}HealthIP` and `RoutingInfo.Configure` to netip](https://github.com/cilium/cilium/pull/47001) on [cilium/cilium](https://github.com/cilium/cilium) (6 days ago)
- [ipam/eni: Derive ENI primary address usage from CiliumNode spec](https://github.com/cilium/cilium/pull/46987) on [cilium/cilium](https://github.com/cilium/cilium) (6 days ago)
