...
- [cilium/cilium](https://github.com/cilium/cilium) ([v1.17.0-pre.3](https://github.com/cilium/cilium/releases/tag/v1.17.0-pre.3), 3 days ago) - eBPF-based Networking, Security, and Observability
- [Sonarr/Sonarr](https://github.com/Sonarr/Sonarr) ([v4.0.11.2724](https://github.com/Sonarr/Sonarr/releases/tag/v4.0.11.2724), 3 days ago) - Smart PVR for newsgroup and bittorrent users.
- [hashicorp/terraform-provider-azurerm](https://github.com/hashicorp/terraform-provider-azurerm) ([v4.12.0](https://github.com/hashicorp/terraform-provider-azurerm/releases/tag/v4.12.0), 6 days ago) - Terraform provider for Azure Resource Manager
- [zigpy/bellows](https://github.com/zigpy/bellows) ([0.42.2](https://github.com/zigpy/bellows/releases/tag/0.42.2), 1 week ago) - A Python 3 project to implement EZSP for EmberZNet devices
...
- [Update changed-files action to v45](https://github.com/canonical/chisel-releases/pull/383) on [canonical/chisel-releases](https://github.com/canonical/chisel-releases) (4 weeks ago)
