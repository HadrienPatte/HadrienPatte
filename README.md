...
- [cilium/statedb](https://github.com/cilium/statedb) ([v0.6.2](https://github.com/cilium/statedb/releases/tag/v0.6.2), 2 days ago) - In-memory state database for Go
- [kubernetes/autoscaler](https://github.com/kubernetes/autoscaler) ([cluster-autoscaler-chart-9.55.0](https://github.com/kubernetes/autoscaler/releases/tag/cluster-autoscaler-chart-9.55.0), 1 week ago) - Autoscaling components for Kubernetes
...
- [cilium-cli: Fix container name in connectivity test logs](https://github.com/cilium/cilium/pull/44076) on [cilium/cilium](https://github.com/cilium/cilium) (1 week ago)
- [Fix cilium version parsing when using `GOEXPERIMENTS`](https://github.com/cilium/cilium/pull/44018) on [cilium/cilium](https://github.com/cilium/cilium) (1 week ago)
- [renovate: Enable major azure SDK upgrades](https://github.com/cilium/cilium/pull/43871) on [cilium/cilium](https://github.com/cilium/cilium) (2 weeks ago)
- [renovate: Fix python dependency updates](https://github.com/cilium/cilium/pull/43695) on [cilium/cilium](https://github.com/cilium/cilium) (3 weeks ago)
- [llvm: Enable renovate updates](https://github.com/cilium/image-tools/pull/439) on [cilium/image-tools](https://github.com/cilium/image-tools) (3 weeks ago)
