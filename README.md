...
- [canonical/chisel](https://github.com/canonical/chisel) ([v1.1.0](https://github.com/canonical/chisel/releases/tag/v1.1.0), 2 days ago) - 
- [Lidarr/Lidarr](https://github.com/Lidarr/Lidarr) ([v2.9.2.4521](https://github.com/Lidarr/Lidarr/releases/tag/v2.9.2.4521), 6 days ago) - Looks and smells like Sonarr but made for music.
- [Sonarr/Sonarr](https://github.com/Sonarr/Sonarr) ([v4.0.12.2825](https://github.com/Sonarr/Sonarr/releases/tag/v4.0.12.2825), 6 days ago) - Smart PVR for newsgroup and bittorrent users.
...
- [Emit azure API rate limits metrics](https://github.com/cilium/cilium/pull/36919) on [cilium/cilium](https://github.com/cilium/cilium) (2 days ago)
