...
- [Lidarr/Lidarr](https://github.com/Lidarr/Lidarr) ([v2.10.1.4589](https://github.com/Lidarr/Lidarr/releases/tag/v2.10.1.4589), 3 days ago) - Looks and smells like Sonarr but made for music.
- [Sonarr/Sonarr](https://github.com/Sonarr/Sonarr) ([v4.0.13.2934](https://github.com/Sonarr/Sonarr/releases/tag/v4.0.13.2934), 3 days ago) - Smart PVR for newsgroup and bittorrent users.
- [hashicorp/terraform-provider-azurerm](https://github.com/hashicorp/terraform-provider-azurerm) ([v4.22.0](https://github.com/hashicorp/terraform-provider-azurerm/releases/tag/v4.22.0), 5 days ago) - Terraform provider for Azure Resource Manager
...
- [Switch operator back to distroless base image](https://github.com/DataDog/cilium/pull/601) on [DataDog/cilium](https://github.com/DataDog/cilium) (6 days ago)
